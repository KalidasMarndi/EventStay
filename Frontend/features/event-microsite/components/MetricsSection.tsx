...
const metrics = [
  {
    display: "Cover → stay",
    label: "Pages live",
    sublabel: "one guest page per event",
  },
  {
    display: "Packages",
    label: "Stay options on the page",
    sublabel: "rooms, villas, and rates guests can book",
  },
  {
    display: "Minutes",
    label: "Time to book",
    sublabel: "from first look to confirmation",
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-1 bg-foreground/[0.02] border border-foreground/10 p-10 lg:p-14 transition-all duration-700 ${
            ...
            <div className="text-4xl md:text-5xl lg:text-6xl font-display tracking-tight mb-4 overflow-hidden">
              {metrics[0].display}
            </div>
            <div className="mb-6">
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span className="text-foreground">Guest itinerary</span>
        </div>
      </div>
    </section>
  );
