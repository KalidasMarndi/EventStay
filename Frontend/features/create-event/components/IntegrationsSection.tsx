...
import { Code2, FileCode2, Globe, Server, Palette, Database, HardDrive, Container } from "lucide-react";

const logos: Record<string, React.ReactNode> = {
  "React": <Code2 className="w-6 h-6" />,
  "TypeScript": <FileCode2 className="w-6 h-6" />,
  ...
  "PostgreSQL": <HardDrive className="w-6 h-6" />,
  ...
  return (
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        <span className={`inline-flex items-center gap-4 text-sm font-mono text-white/50 mb-8 transition-all duration-700 justify-center ${
        ...
        <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display text-white tracking-tight leading-[0.9] transition-all duration-1000 ${
          ...
          Event
          <br />
          <span className="text-[#eab308]">Infrastructure.</span>
        </h2>

        <p className={`mt-8 text-xl text-white/70 leading-relaxed max-w-lg mx-auto transition-all duration-1000 delay-100 ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
          Powered by modern technology to ensure a scalable, secure, and lightning-fast booking experience.
        </p>
      </div>
      ...
      <div className={`relative left-1/2 -translate-x-1/2 w-screen -mt-16 transition-all duration-1000 delay-200 ${
        ...
        <img
          ...
          aria-hidden="true"
          className="w-full h-auto max-h-[600px] object-cover opacity-40 mix-blend-screen"
        />
