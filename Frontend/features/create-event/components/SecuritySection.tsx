...
const securityFeatures = [
  {
    ...
    description: "Every event microsite is invite-only.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Secure payments",
    description: "Guest payments are processed with bank-level encryption.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Live inventory tracking",
    description: "Real-time visibility into who booked what.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Role-based access",
    description: "Give planners, travel agents, and admins the right controls.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["SOC 2", "ISO 27001", "PCI DSS", "GDPR"];
    ...
    <section id="security" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[110px] font-display tracking-tight leading-[0.95] mb-8 transition-all duration-1000 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}>
            Seamless,
            <br />
            <span className="text-muted-foreground">yet secure.</span>
          </h2>

          <p className={`text-xl text-muted-foreground leading-relaxed transition-all duration-1000 delay-100 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}>
            Your group travel data is protected. Enterprise-grade security ensures guest details and payments are always safe.
          </p>
        </div>
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8">
                ...
                <span className="block text-muted-foreground mt-2">Booking errors this year</span>
              </div>
            </div>
